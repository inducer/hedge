...
<\body>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|0>|<cell|=>|<cell|<big|int><rsub|T<rsub|k>>u<rsub|t>\<varphi\>-<big|int><rsub|T<rsub|k>>(\<nabla\>\<cdot\>v)\<varphi\>>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsub|T<rsub|k>>u<rsub|t>\<varphi\>+<big|int><rsub|D<rsub|k>>v\<cdot\>\<nabla\>\<varphi\>-<big|int><rsub|T<rsub|k>>\<nabla\>\<cdot\>(v\<varphi\>)>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsub|T<rsub|k>>u<rsub|t>\<varphi\>+<big|int><rsub|D<rsub|k>>\<b-v\>\<cdot\>\<nabla\>\<varphi\>-<big|int><rsub|\<partial\>T<rsub|k>>v\<varphi\>\<cdot\>n>>|<row|<cell|>|<cell|\<approx\>>|<cell|<big|int><rsub|T<rsub|k>>u<rsub|t>\<varphi\>+<big|int><rsub|D<rsub|k>>\<b-v\>\<cdot\>\<nabla\>\<varphi\>-<big|int><rsub|\<partial\>T<rsub|k>>v<rsup|\<ast\>>\<varphi\>\<cdot\>n>>|<row|<cell|>|<cell|\<approx\>>|<cell|<big|int><rsub|T<rsub|k>>\<partial\><rsub|t>u<rsub|i>l<rsub|i>l<rsub|j>+<big|int><rsub|T<rsub|k>><matrix|<tformat|<table|<row|<cell|[v<rsub|i>]<rsub|1>l<rsub|i>>>|<row|<cell|[v<rsub|i>]<rsub|2>l<rsub|i>>>>>>\<cdot\><matrix|<tformat|<table|<row|<cell|\<partial\><rsub|x<rsub|2>>l<rsub|j>>>|<row|<cell|\<partial\><rsub|x<rsub|2>>l<rsub|j>>>>>>-<big|int><rsub|\<partial\>T<rsub|k>><matrix|<tformat|<table|<row|<cell|[v<rsub|i>]<rsup|\<ast\>><rsub|1>l<rsub|j>>>|<row|<cell|[v<rsub|i>]<rsup|\<ast\>><rsub|2>l<rsub|j>>>>>>\<cdot\>n>>|<row|<cell|>|<cell|=>|<cell|M<rsub|i
    j><rsup|k>\<partial\><rsub|t>u<rsub|i>+S<rsub|i
    j,\<partial\>x<rsub|1>><rsup|k>[v<rsub|i>]<rsub|1>+S<rsub|i
    j,\<partial\>x<rsub|2>><rsup|k>[v<rsub|i>]<rsub|2>-<big|int><rsub|\<partial\>T<rsub|k>><matrix|<tformat|<table|<row|<cell|[v<rsub|i>]<rsup|\<ast\>><rsub|1>l<rsub|j>>>|<row|<cell|[v<rsub|i>]<rsup|\<ast\>><rsub|2>l<rsub|j>>>>>>\<cdot\>n>>|<row|<cell|>|<cell|=>|<cell|(M<rsup|k>)<rsup|T>\<partial\><rsub|t>\<b-u\>+(S<rsub|\<partial\>x<rsub|1>><rsup|k>)<rsup|T>\<b-v\><rsub|1>+S<rsub|\<partial\>x<rsub|2>><rsup|k>\<b-v\><rsub|2>-<big|int><rsub|\<partial\>T<rsub|k>><matrix|<tformat|<table|<row|<cell|[v<rsub|i>]<rsup|\<ast\>><rsub|1>l<rsub|j>>>|<row|<cell|[v<rsub|i>]<rsup|\<ast\>><rsub|2>l<rsub|j>>>>>>\<cdot\>n>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    ...
    j,\<partial\>x<rsub|\<nu\>>><rsup|k>>|<cell|\<assign\>>|<cell|<big|int><rsub|T<rsub|k>>l<rsub|i>\<partial\><rsub|x<rsub|\<nu\>>>l<rsub|j>.>>>>
  </eqnarray*>
  ...
  <\equation*>
    V<rsup|T>\<b-l\>(x)=<matrix|<tformat|<table|<row|<cell|p<rsub|1>(x<rsub|1>)>|<cell|>|<cell|p(x<rsub|n>)>>|<row|<cell|\<vdots\>>|<cell|>|<cell|\<vdots\>>>|<row|<cell|p<rsub|n>(x<rsub|1>)>|<cell|\<cdots\>>|<cell|p<rsub|n>(x<rsub|n>)>>>>>\<b-l\>(x)=<matrix|<tformat|<table|<row|<cell|l<rsub|1>(x)p<rsub|1>(x<rsub|1>)+\<cdots\>+l<rsub|n>(x)p<rsub|1>(x<rsub|n>)>>|<row|<cell|>>|<row|<cell|l<rsub|1>(x)p<rsub|1>(x<rsub|1>)+\<cdots\>+l<rsub|n>(x)p<rsub|1>(x<rsub|n>)>>>>>=<matrix|<tformat|<table|<row|<cell|p<rsub|1>(x)>>|<row|<cell|>>|<row|<cell|>>>>>,
  </equation*>
  ...
  <\equation*>
    [D<rsub|x<rsub|\<nu\>>>]<rsub|i,j>=\<partial\><rsub|x<rsub|\<nu\>>>(l<rsub|j>(F<rsup|-1><rsub|k>(x<rsup|(i)>)))=(\<partial\><rsub|r>l<rsub|j>)(r<rsup|(i)><rsup|>)(F<rsub|k><rsup|-1>)<rprime|'>(x<rsup|(i)>)=D<rsub|r<rsub|\<nu\>>>(F<rsup|-1><rsub|k>)<rprime|'>(x<rsup|(i)>).
  </equation*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|0>|<cell|=>|<cell|<big|int><rsub|D<rsub|k>>\<b-v\><rsub|t>\<cdot\><with|math-font-series|bold|\<psi\>>-<big|int><rsub|D<rsub|k>>\<nabla\>u\<cdot\><with|math-font-series|bold|\<psi\>>>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsub|D<rsub|k>>\<b-v\><rsub|t>\<cdot\><with|math-font-series|bold|\<psi\>>+<big|int><rsub|D<rsub|k>>u\<nabla\>\<cdot\><with|math-font-series|bold|\<psi\>>+<big|int><rsub|D<rsub|k>>\<nabla\>\<cdot\>(u<with|math-font-series|bold|\<psi\>>)>>|<row|<cell|>|<cell|=>|<cell|<big|int><rsub|D<rsub|k>>\<b-v\><rsub|t>\<cdot\><with|math-font-series|bold|\<psi\>>+<big|int><rsub|D<rsub|k>>u\<nabla\>\<cdot\><with|math-font-series|bold|\<psi\>>+<big|int><rsub|\<partial\>D<rsub|k>>u<with|math-font-series|bold|\<psi\>>\<cdot\>\<b-n\>>>|<row|<cell|>|<cell|\<approx\>>|<cell|<big|int><rsub|D<rsub|k>>\<b-v\><rsub|t>\<cdot\><with|math-font-series|bold|\<psi\>>+<big|int><rsub|D<rsub|k>>u\<nabla\>\<cdot\><with|math-font-series|bold|\<psi\>>+<big|int><rsub|\<partial\>D<rsub|k>>u<rsup|\<ast\>><with|math-font-series|bold|\<psi\>>\<cdot\>\<b-n\>>>>>
  </eqnarray*>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      <vspace*|1fn><with|font-series|<quote|bold>|math-font-series|<quote|bold>|DG
      for the Wave Equation> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
