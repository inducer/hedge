...
namespace hedge {
  ...
  class triangle_basis_function
  {
    public:
      ...
      double operator()(const numpy_vector<double> &x)
      {
        double r = x[0];
        double s = x[1];
  ...
  class grad_triangle_basis_function
  {
    public:
      ...
      boost::tuple<double, double> operator()(const numpy_vector<double> &x)
      {
        double r = x[0];
        double s = x[1];
  ...
  class grad_tetrahedron_basis_function
  {
    public:
      ...
      boost::tuple<double, double, double> operator()(const numpy_vector<double> &x)
      {
        double r = x[0];
        double s = x[1];
        double t = x[2];
