...
class Mesh:
    ...
    def _get_gmsh_element_type_to_info_map(self):
        ...
        class ElementTypeInfo(Record): pass
        
        from hedge.element import TriangularElement,TetrahedralElement
        print ElementTypeInfo(TriangularElement(1))
        return {
                1:  "Line",
                2:  ElementTypeInfo(TriangularElement(1)),
                8:  "2nd order Line",
                9:  ElementTypeInfo(TriangularElement(2)),
                11: ElementTypeInfo(TetrahedralElement(2)),
                20: ElementTypeInfo(TetrahedralElement(3)),
                21: ElementTypeInfo(TetrahedralElement(3)),
                22: ElementTypeInfo(TetrahedralElement(4)),
                23: ElementTypeInfo(TetrahedralElement(4)),
                24: ElementTypeInfo(TetrahedralElement(5)),
                25: ElementTypeInfo(TetrahedralElement(5)),
                26: ElementTypeInfo(TetrahedralElement(4)),
                27: ElementTypeInfo(TetrahedralElement(4)), 
                28: ElementTypeInfo(TetrahedralElement(4)), 
                29: ElementTypeInfo(TetrahedralElement(3)),
                30: ElementTypeInfo(TetrahedralElement(4)),
                31: ElementTypeInfo(TetrahedralElement(5)),
                }
   """
